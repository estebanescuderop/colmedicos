...
variable2 = [{
      "operations": [
        {
          "op": "distinct_count",
          "alias": "personas_unicas_por_actividad",
          "column": "documento",
          "conditions_all": [],
          "conditions_any": []
        }
...
#out2 = ejecutar_operaciones_condicionales(df_datos,variable2[0])
out2, meta = operaciones_con_metadatos(df_datos,variable2[0])
out2 = enriquecer_texto_con_metadatos(str(out2),meta)
#fig, ax = plot_from_params(df_datos,variable2[0])
#print(fig)

#out = _fig_to_data_uri(out2)
print(out2)
